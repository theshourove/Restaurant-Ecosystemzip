/**
 * PETUK database seed script
 * Run from lib/db: node seed.mjs
 */
import pg from "pg";
...
async function seedSettings() {
  ...
  await q(
    `INSERT INTO settings (id, restaurant_name, address, phone, tax_enabled, tax_rate, tax_name,
       currency, paper_width, delivery_fee, delivery_fee_enabled,
       points_per_100_taka, points_redemption_rate,
       max_cashier_discount_percent, max_cashier_discount_amount, sync_api_key)
